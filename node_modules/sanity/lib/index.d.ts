...
import {FormDocumentValue as FormDocumentValue_2} from 'sanity'
...
export declare function ChangeConnectorRoot({
  ...
  onSetFocus,
  ...restProps
}: ChangeConnectorRootProps): JSX_2.Element
...
declare function ChangeIndicatorsTrackerComponent(props: {children: React.ReactNode}): JSX_2.Element

/** @internal */
export declare type ChangeIndicatorTrackerContextValue = TrackedChange | TrackedArea
...
export declare interface CopyPasteContextType {
  ...
  onCopy: (
    path: Path_2,
    value: FormDocumentValue_2 | undefined,
    options: CopyOptions,
  ) => Promise<void>
  onPaste: (
    targetPath: Path_2,
...
/** @internal */
export declare function FieldPresence(props: FieldPresenceProps): JSX_2.Element
 ...
 * @hidden
 */
export declare function GetFormValueProvider(props: {
  value: FormDocumentValue | undefined
  children: ReactNode
}): JSX_2.Element
...
export declare const ObjectInput: NamedExoticComponent<
  ObjectInputProps<Record<string, any>, ObjectSchemaType_2>
>
...
export declare const operatorDefinitions: (
  ...
  | (SearchOperatorBuilder<'assetFileEqual', Reference> & {
      ...
      inputComponent: ({
        onChange,
        value,
      }: OperatorInputComponentProps<ReferenceValue>) => JSX_2.Element
      label: string
      type: 'assetFileEqual'
    })
...
/** @internal */
export declare function PresenceOverlay({children, margins}: PresenceOverlayProps): JSX_2.Element
 ...
 * @hidden
 * @beta */
export declare type PreviewableType = SchemaType | CrossDatasetType
