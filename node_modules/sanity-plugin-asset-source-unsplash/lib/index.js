...
import { Card, Text, Stack, Dialog, TextInput, Flex, Spinner } from '@sanity/ui';
...
var _a, _b;
const Search = styled(Stack)(_a || (_a = __template(["\n  position: sticky;\n  top: 0;\n  z-index: 1;\n"])));
styled.div(_b || (_b = __template(["\n  overflow-y: auto;\n  max-height: 80vh;\n"])));
...
class UnsplashAssetSourceInternal extends React.Component {
  constructor() {
    ...
    __publicField(this, "searchSubject$", new BehaviorSubject(""));
    __publicField(this, "pageSubject$", new BehaviorSubject(1));
